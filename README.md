...
# Approche utilisée
La démarche adoptée pour ce travail consiste en premier lieu de représenter un objet Pixel et un oune image comme un objet ayant trois attributs :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzE5OTU1ODg3XX0=
-->