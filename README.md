...
Cette classe contient les 3 méthodes principales :
 ...
 - min_energie : qui retourne un dictionnaire qui contient pour chaque valeur d'énergie un seam, et e dictionnaire sera ordonné   

 

 
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjg0OTk1MDE1XX0=
-->